...
@section('title')
    @if(request('id')>0) Update @else Create @endif Carousel
@endsection
            ...
            <div class="col-lg-6 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <form action="@if(request('id')>0) {{route('admin.web.carousel.update', ['id'=>$carousel->id])}} @else {{route('admin.web.carousel.store')}} @endif" method="post" enctype="multipart/form-data">
                                    @csrf
